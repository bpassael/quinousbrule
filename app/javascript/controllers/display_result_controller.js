  ...
  display(event) {
    ...
    fetch(url, {
      ...
      .then((data) => {
        ...
        this.tweetTarget.href = `https://twitter.com/intent/tweet?text=Mon empreinte carbone annuelle est de ${annualFootprint} kgCO2e soit ${jetComparaison} de vol du jet privé de Vincent Bolloré ou ${yachtComparaison}km parcourus par le yacht de Bernard Arnault. A quoi servent mes efforts ? https://pic.twitter.com/XnIujtmLWg&hashtags=quinousbrule`
        this.tweettextTarget.innerText = `Mon empreinte carbone annuelle est de ${annualFootprint} kgCO2e soit ${jetComparaison} de vol du jet de Vincent Bolloré ou ${yachtComparaison}km parcourus par le yacht de Bernard Arnault. A quoi servent mes efforts ? https://pic.twitter.com/XnIujtmLWg&hashtags=quinousbrule`
