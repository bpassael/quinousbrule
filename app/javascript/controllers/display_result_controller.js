  ...
  display(event) {
    ...
    fetch(url, {
      ...
      .then((data) => {
        ...
        this.tweetTarget.href = `https://twitter.com/intent/tweet?text=Mon empreinte carbone annuelle est de ${annualFootprint} tonnes de CO2e soit ${jetComparaison} de vol dans un jet privé, ou ${yachtComparaison}km parcourus par un yacht. A quoi servent mes efforts ? https://pic.twitter.com/yg32d9s7Po&hashtags=quinousbrule`
        this.tweettextTarget.innerText = `Mon empreinte carbone annuelle est de ${annualFootprint} tonnes de CO2e soit ${jetComparaison} de vol dans un jet privé, ou ${yachtComparaison}km parcourus par un yacht. A quoi servent mes efforts ? https://pic.twitter.com/yg32d9s7Po&hashtags=quinousbrule`
        this.mailtextTarget.innerText = `Le site quinousbrule.fr m'a permis de réaliser que mon empreinte carbone annuelle de ${annualFootprint} tonnes de CO2e par an équivaut à la consommation carburant de ${jetComparaison} de vol dans un jet privé, ou de ${yachtComparaison} kilomètres parcourus par un yacht.%0D%0A%0D%0AQue faites-vous pour lutter contre les vrais responsables du réchauffement climatique ?%0D%0A%0D%0ACordialement,%0D%0A%0D%0AVOTRE NOM`
