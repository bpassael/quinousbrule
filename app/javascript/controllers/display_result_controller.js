  ...
  display(event) {
    ...
    fetch(url, {
      ...
      .then((data) => {
        ...
        this.tweettextTarget.innerText = `Mon empreinte carbone annuelle est de ${annualFootprint} kgCO2e soit ${jetComparaison} de vol du jet de Vincent Bolloré ou ${yachtComparaison}km parcourus par le yacht de Bernard Arnault. A quoi servent mes efforts ? https://pic.twitter.com/yg32d9s7Po&hashtags=quinousbrule`
